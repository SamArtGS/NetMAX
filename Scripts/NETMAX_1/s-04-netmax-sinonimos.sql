...
create or replace synonym usuario_f3 for usuario_f3_jcc_s1;
...
-- PROGRAMA
create or replace synonym programa_f1 for programa_f1_jcc_s1;
...
-- DOCUMENTAL
create or replace synonym documental_f1 for documental_f1_jcc_s1;
...
-- PELICULA
create or replace synonym pelicula_f1 for pelicula_f1_jcc_s1;
...
-- SERIE
create or replace synonym serie_f1 for serie_f1_jcc_s1;
...
create or replace synonym playlist_f2 for playlist_f2_jcc_s1;
...
-- STATUS PROGRAMA
create or replace synonym status_programa_r1 for status_programa_jcc_s1;
...
-- TIPO_CUENTA
create or replace synonym tipo_cuenta_r1 for tipo_cuenta_r_jcc_s1;
...
-- PAIS
create or replace synonym pais_r1 for pais_r_jcc_s1;
...
-- TIPO_SERIE
create or replace synonym tipo_serie_r1 for tipo_serie_r_jcc_s1;
