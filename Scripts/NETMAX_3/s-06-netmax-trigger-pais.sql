...
v_count := 0;
--replica local
delete from pais_r1 where pais_id = :old.pais_id; v_count := v_count + sql%rowcount;
--replica 2
delete from pais_r2 where pais_id = :old.pais_id; v_count := v_count + sql%rowcount;
--replica 3
delete from pais_r3 where pais_id = :old.pais_id; v_count := v_count + sql%rowcount;
--replica 4
delete from pais_r4 where pais_id = :old.pais_id; v_count := v_count + sql%rowcount;
if v_count <> 4 then raise_application_error(-20040,
