...
-- USUARIO
create or replace synonym usuario_f1 for usuario_f1_sgs_s1;
...
create or replace synonym usuario_f4 for usuario_f4_sgs_s1;
create or replace synonym usuario_f5 for usuario_f5_jcc_s2@netmax_s2;

-- PROGRAMA
create or replace synonym programa_f1 for programa_f1_jcc_s1@netmax_s1;
create or replace synonym programa_f2 for programa_f2_sgs_s1;
...
create or replace synonym documental_f2 for documental_f2_sgs_s1;
...
create or replace synonym pelicula_f2 for pelicula_f2_sgs_s1;
...
create or replace synonym serie_f2 for serie_f2_sgs_s1;
...
-- ARCHIVO_PROGRAMA
create or replace synonym archivo_programa_f1 for archivo_programa_f1_jcc_s2@netmax_s2;
create or replace synonym archivo_programa_f2 for archivo_programa_f2_sgs_s1;
...
create or replace synonym playlist_f3 for playlist_f3_sgs_s1;
create or replace synonym playlist_f4 for playlist_f4_jcc_s2@netmax_s2;

-- STATUS PROGRAMA
create or replace synonym status_programa_r1 for status_programa_jcc_s1@netmax_s1;
create or replace synonym status_programa_r2 for status_programa_jcc_s2@netmax_s2;
create or replace synonym status_programa_r3 for status_programa_sgs_s1;
...
create or replace synonym tipo_cuenta_r2 for tipo_cuenta_r_jcc_s2@netmax_s2;
create or replace synonym tipo_cuenta_r3 for tipo_cuenta_r_sgs_s1;
...
create or replace synonym pais_r2 for pais_r_jcc_s2@netmax_s2;
create or replace synonym pais_r3 for pais_r_sgs_s1;
...
create or replace synonym tipo_serie_r2 for tipo_serie_r_jcc_s2@netmax_s2;
create or replace synonym tipo_serie_r3 for tipo_serie_r_sgs_s1;
