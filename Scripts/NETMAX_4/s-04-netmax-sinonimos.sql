...
create or replace synonym usuario_f2 for usuario_f2_sgs_s2;
...
create or replace synonym programa_f3 for programa_f3_sgs_s2;
...
create or replace synonym documental_f3 for documental_f3_sgs_s2;
...
create or replace synonym pelicula_f3 for pelicula_f3_sgs_s2;
...
create or replace synonym serie_f3 for serie_f3_sgs_s2;

-- HISTORICO_STATUS_PROGRAMA
create or replace synonym historico_status_programa_f1 for historico_status_programa_sgs_s2;
...
-- PLAYLIST
create or replace synonym playlist_f1 for playlist_f1_sgs_s2;
...
create or replace synonym status_programa_r4 for status_programa_sgs_s2;
...
create or replace synonym tipo_cuenta_r4 for tipo_cuenta_r_sgs_s2;
...
create or replace synonym pais_r4 for pais_r_sgs_s2;
...
create or replace synonym tipo_serie_r4 for tipo_serie_r_sgs_s2;
