...
CREATE TABLE PROGRAMA_F3_SGS_S2(
    ...
    PARTITION PROGRAMA_F3_SGS_S2_P1, 
    PARTITION PROGRAMA_F3_SGS_S2_P2, 
    PARTITION PROGRAMA_F3_SGS_S2_P3, 
    PARTITION PROGRAMA_F3_SGS_S2_P4,
    PARTITION PROGRAMA_F3_SGS_S2_P5
);
...
CREATE TABLE HISTORICO_STATUS_PROGRAMA_SGS_S2(
  ...
  SUBPARTITION TEMPLATE(
    SUBPARTITION HISTORICO_STATUS_PROGRAMA_SGS_S2_SP1, 
    SUBPARTITION HISTORICO_STATUS_PROGRAMA_SGS_S2_SP2, 
    SUBPARTITION HISTORICO_STATUS_PROGRAMA_SGS_S2_SP3, 
    SUBPARTITION HISTORICO_STATUS_PROGRAMA_SGS_S2_SP4
)
(
  PARTITION H_ANTIGUA VALUES LESS THAN(TO_DATE('01/2010','MM/YYYY'))
);
...
CREATE TABLE USUARIO_F2_SGS_S2(
    ...
    ON DELETE CASCADE
) PARTITION BY LIST(TIPO_CUENTA_ID)(
    partition USUARIO_F2_SGS_S2_P1 values (1), 
    partition USUARIO_F2_SGS_S2_P2 values (2),
    partition USUARIO_F2_SGS_S2_P3 values (3)
);
