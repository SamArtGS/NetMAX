...
grant read, write on directory PROY_FINAL_PDFS_DIR to netmax_bdd;
grant read, write on directory PROY_FINAL_TRAILERS_DIR to netmax_bdd;
...
grant execute on fx_carga_blob to netmax_bdd;